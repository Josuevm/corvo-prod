...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__comparative_chart_car_selector_touch_car_selector_touch_component__ = __webpack_require__("./src/app/comparative_chart/car-selector-touch/car-selector-touch.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_30__comparative_chart_car_selector_touch_car_selector_touch_component__["a" /* CarSelectorTouchComponent */]
            ],
            imports: [
...
var GeneralFeaturePickerComponent = /** @class */ (function () {
    ...
    GeneralFeaturePickerComponent.prototype.ngOnChanges = function () {
        this.changeDataType();
    };
...
var ModelsComponent = /** @class */ (function () {
    ...
    ModelsComponent.prototype.ngOnInit = function () {
        ...
        this.carData.getModels().subscribe(function (res) {
            ...
            _this.selectedCarSrv.getDefaultData(_this.selectedModelName);
        });
    };
...
var PreviewModalComponent = /** @class */ (function () {
    function PreviewModalComponent(modalService, selectedCarSrv) {
        this.modalService = modalService;
        this.selectedCarSrv = selectedCarSrv;
        this.subT = 0;
        this.details = [];
    ...
    PreviewModalComponent.prototype.hideModal = function () {
    };
    ...
    PreviewModalComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__["a" /* BsModalService */], __WEBPACK_IMPORTED_MODULE_2__selected_car_service__["a" /* SelectedCarService */]])
