...
var PreviewModalComponent = /** @class */ (function () {
    ...
    PreviewModalComponent.prototype.downloadPDF = function () {
        var clone = $("#PDFcontent").clone();
        var cloneCar = $("#car").clone();
        clone.css({
            height: 2000,
            "font-size": "2vw",
            "color": "white",
